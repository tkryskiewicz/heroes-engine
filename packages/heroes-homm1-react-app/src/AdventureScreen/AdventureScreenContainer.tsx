...
import { AdventureOptionsWindow, AdventureScreen, GameText } from "heroes-homm1-react";
...
export class AdventureScreenContainer extends React.Component<RouteComponentProps> {
  public render() {
    return (
